...
import com.comics.jiabin.awutils.*;
import javax.imageio.ImageIO;
import io.github.bonigarcia.wdm.WebDriverManager;

public class AwUtils {
    public void findByidClick(WebDriver driver,String str) {
        driver.findElement(By.id(str)).click();
    }
    public void findByidsend(WebDriver driver,String str,String text) {
        driver.findElement(By.id(str)).sendKeys(text);
    }
    //截图命名为当前时间保存桌面
...
//    }
    //截图重命名保存至桌面
//    public void takeScreenshotByName(WebDriver driver,String name) throws IOException {
//        File srcFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
